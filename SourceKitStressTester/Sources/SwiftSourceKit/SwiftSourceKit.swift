...
extension Sourcekitd.SyntaxTreeFormat {
  ...
  /// debugging.
  public static var json: Sourcekitd.SyntaxTreeFormat<Data> {
  ...
  public static var byteTree: Sourcekitd.SyntaxTreeFormat<Data> {
  ...
  ) -> Sourcekitd.SyntaxTreeFormat<NewTree> {
...
extension Sourcekitd.SourceFile {
  init(path: String) {
